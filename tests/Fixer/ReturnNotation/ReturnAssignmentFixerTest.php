 ...
 *
 * @phpstan-import-type _AutogeneratedInputConfiguration from ReturnAssignmentFixer
 *
 * @no-named-arguments Parameter names are not covered by the backward compatibility promise.
 *
 * @phpstan-import-type _AutogeneratedInputConfiguration from \PhpCsFixer\Fixer\ReturnNotation\ReturnAssignmentFixer
 */
final class ReturnAssignmentFixerTest extends AbstractFixerTestCase
{
    ...
    public static function provideInvalidConfigurationCases(): iterable
    {
        yield 'invalid option' => [
            ['foo' => true],
            '/^\[return_assignment\] Invalid configuration: The option "foo" does not exist\. Defined options are: "skip_named_var_tags"\.$/',
        ];

        yield 'wrong config type for "skip_named_var_tags"' => [
            ['skip_named_var_tags' => '123'],
            '/^\[return_assignment\] Invalid configuration: The option "skip_named_var_tags" with value "123" is expected to be of type "bool", but is of type "string"\.$/',
        ];
    }
...
',
        ...
        yield 'doc comment with @var tag for the variable (without variable name and default config)' => [
            '<?php
...
',
        ...
        yield 'doc comment with @var tag for the variable (without variable name and "skip_named_var_tags" option)' => [
            '<?php
...
',
        ...
        yield 'doc comment with @var tag for the variable (with variable name and default config)' => [
            '<?php
...
',
        ...
        yield 'doc comment with @var tag for the variable (with variable name and "skip_named_var_tags" option)' => [
            '<?php
...
',
        ...
        yield 'doc comment with @phpstan-var tag for the variable (without variable name and default config)' => [
            '<?php
...
',
        ...
        yield 'doc comment with @phpstan-var tag for the variable (without variable name and "skip_named_var_tags" option)' => [
            '<?php
...
',
        ...
        yield 'doc comment with @phpstan-var tag for the variable (with variable name and default config)' => [
            '<?php
...
',
        ...
        yield 'doc comment with @phpstan-var tag for the variable (with variable name and "skip_named_var_tags" option)' => [
            '<?php
...
',
        ...
        yield 'doc comment with @psalm-var tag for the variable (without variable name and default config)' => [
            '<?php
...
',
        ...
        yield 'doc comment with @psalm-var tag for the variable (without variable name and "skip_named_var_tags" option)' => [
            '<?php
...
',
        ...
        yield 'doc comment with @psalm-var tag for the variable (with variable name and default config)' => [
            '<?php
...
',
        ...
        yield 'doc comment with @psalm-var tag for the variable (with variable name and "skip_named_var_tags" option)' => [
            '<?php
