...
',
    ...
    /**
     * @dataProvider provideFix80ForceLastPositionCases
     *
     * @requires PHP 8.0
     */
    public function testFix80ForceLastPosition(string $expected, ?string $input = null): void
    {
        $this->fixer->configure(['syntax' => 'union', 'union_null_position' => 'last']);
     ...
     * @return iterable<string, array{string, 1?: ?string}>
     */
    public static function provideFix80ForceLastPositionCases(): iterable
    {
        yield 'changes ? to union with null at the end' => [
            "<?php\nfunction baz(Foo|null \$foo, int|string \$value, array|null \$config = null): int|null {}\n",
            "<?php\nfunction baz(?Foo \$foo, int|string \$value, ?array \$config = null): ?int {}\n",
        ];

        yield 'reorders types to place null at the end' => [
            "<?php\nfunction baz(Foo|null \$foo, int|string \$value, array|null \$config = null): int|null {}\n",
            "<?php\nfunction baz(null|Foo \$foo, int|string \$value, null|array \$config = null): null|int {}\n",
        ];
    }
    ...
    /**
     * @dataProvider provideFix80ForceFirstPositionCases
     *
     * @requires PHP 8.0
     */
    public function testFix80ForceFirstPosition(string $expected, ?string $input = null): void
    {
        $this->fixer->configure(['syntax' => 'union', 'union_null_position' => 'first']);
     ...
     * @return iterable<string, array{string, 1?: ?string}>
     */
    public static function provideFix80ForceFirstPositionCases(): iterable
    {
        yield 'reorders types to place null at the beginning' => [
            "<?php\nfunction baz(null|Foo \$foo, int|string \$value, null|array \$config = null): null|int {}\n",
            "<?php\nfunction baz(Foo|null \$foo, int|string \$value, array|null \$config = null): int|null {}\n",
        ];
    }
    ...
    /**
     * @dataProvider provideFix80DoNotChangeUnionOrderCases
     *
     * @requires PHP 8.0
     */
    public function testFix80DoNotChangeUnionOrder(string $expected, ?string $input = null): void
    {
        $this->fixer->configure(['syntax' => 'union', 'union_null_position' => 'any']);
     ...
     * @return iterable<string, array{string, 1?: ?string}>
     */
    public static function provideFix80DoNotChangeUnionOrderCases(): iterable
    {
        yield 'does not change existing union order, newly created unions places null at the beginning' => [
            "<?php\nfunction baz(Foo|null \$foo, int|string \$value, array|null \$config = null): null|int {}\n",
            "<?php\nfunction baz(Foo|null \$foo, int|string \$value, array|null \$config = null): ?int {}\n",
        ];
    }
