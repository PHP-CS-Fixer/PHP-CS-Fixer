...
&=$b;',
    ...
    public function testWrongConfigItem()
    {
        $this->setExpectedExceptionRegExp(
            ...
            '/^\[align_operator_spaces\] Unknown configuration option "foo"\. Expected any of "align_equals", "align_double_arrow"\.$/'
        );
    ...
    public function testWrongConfigValue()
    {
        $this->setExpectedExceptionRegExp(
            'PhpCsFixer\ConfigurationException\InvalidFixerConfigurationException',
            '/^\[align_operator_spaces\] Invalid value type for configuration option "align_double_arrow"\. Expected "bool" or "null" got "integer"\.$/'
        );
