 ...
 * @internal
 *
 * @covers \PhpCsFixer\Fixer\Operator\NegatedInstanceofWithParenthesesFixer
 *
 * @extends AbstractFixerTestCase<\PhpCsFixer\Fixer\Operator\NegatedInstanceofWithParenthesesFixer>
 *
 * @author Jérôme Gamez <jerome@gamez.name>
 *
 * @phpstan-import-type _AutogeneratedInputConfiguration from \PhpCsFixer\Fixer\Operator\NegatedInstanceofWithParenthesesFixer
 *
 * @no-named-arguments Parameter names are not covered by the backward compatibility promise.
 */
final class NegatedInstanceofWithParenthesesFixerTest extends AbstractFixerTestCase
{
    /**
