 ...
 * @phpstan-import-type _ClassReferenceInfo from \PhpCsFixer\Fixer\ClassNotation\ClassDefinitionFixer
    ...
    \Fcc, \GFddZz
{
    ...
    /**
     * @return iterable<array{0: string, 1: _ClassReferenceInfo}>
     */
...
namespace {
    ...
    /**
     * @return iterable<int, array{0: string, 1: _ClassReferenceInfo}>
     */
