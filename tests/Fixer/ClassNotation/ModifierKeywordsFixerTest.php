...
var_dump(Foo::CAT->test());',
    ...
    public static function provideFix84Cases(): iterable
    {
        ...
        yield 'fixing multiple keyword modifiers, omit general public visibility' => [
            <<<'PHP'
                <?php
                abstract class ClassName
                {
                    ...
                    final private(set) int $counter1;

                    protected(set) int $counter2;

                    public(set) int $counter3;

                    public $counter4;

                    public readonly string $counter5;
        ...
        yield 'general public visibility left as it is, whether declared or not' => [
            <<<'PHP'
                <?php
                abstract class ClassName
                {
                    ...
                    public private(set) Baz $b;

                    protected private(set) Baz $c;

                    public private(set) Baz $d;

                    private(set) Baz $e;

                    public $f;

                    public readonly Bar $g;
            ...
            <<<'PHP'
                ...
                abstract class ClassName
                {
                    ...
                    private(set) protected Baz $c;

                    private(set) public Baz $d;
        ...
        yield 'asymmetric visibility with only set-visibility, omit general public visibility' => [
            <<<'PHP'
                <?php class Foo
                {
                    public(set) Bar $a;
        ...
        yield 'asymmetric visibility with set-visibility before general visibility, omit general public visibility' => [
            <<<'PHP'
                <?php class Foo
                {
                    public(set) Bar $a;
        ...
        yield 'asymmetric visibility with readonly, omit general public visibility' => [
            <<<'PHP'
                <?php class Foo
                {
                    protected private(set) readonly Bar $a;
                    protected(set) readonly Bar $b;
                    private(set) readonly Baz $c;
                }
                PHP,
            <<<'PHP'
                <?php class Foo
        ...
        yield 'promoted property with visibility, set-visibility and reference, omit general public visibility' => [
            <<<'PHP'
                <?php class Foo
                {
                    public function __construct(
    ...
    public static function provideInvalidConfigurationCases(): iterable
    {
        ...
        yield 'invalid general visibility handling' => [
            ['general_visibility_when_set_visibility_present' => '_unknown_'],
            '/^\[modifier_keywords\] Invalid configuration: The option "general_visibility_when_set_visibility_present" .*\.$/',
        ];
    }
}
