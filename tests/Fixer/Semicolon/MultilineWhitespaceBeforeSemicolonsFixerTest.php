...
final class MultilineWhitespaceBeforeSemicolonsFixerTest extends AbstractFixerTestCase
{
    ...
    /**
     * @return iterable<int, array{0: string, 1?: null|string, 2?: _AutogeneratedInputConfiguration, 3?: bool}>
     */
    public static function provideFixCases(): iterable
    {
        foreach (self::provideFixCasesWithoutDupes() as $case) {
            yield $case;

            // Run tests for other strategies without duplicating code
            if (($case[2]['strategy'] ?? null) === MultilineWhitespaceBeforeSemicolonsFixer::STRATEGY_NEWLINE_FOR_CHAINED_METHOD_CALLS) {
                $case[2]['strategy'] = MultilineWhitespaceBeforeSemicolonsFixer::STRATEGY_NEW_LINE_FOR_CHAINED_CALLS;

                yield $case;

                $case[2]['strategy'] = MultilineWhitespaceBeforeSemicolonsFixer::STRATEGY_NEWLINE_FOR_CHAINED_CALLS;
     ...
     * @return iterable<int, array{0: string, 1?: null|string, 2?: _AutogeneratedInputConfiguration, 3?: bool}>
     */
    private static function provideFixCasesWithoutDupes(): iterable
    {
        yield [
            '<?php
                    $foo->bar(); // test',
