...
final class PsrAutoloadingFixerTest extends AbstractFixerTestCase
{
    public function testInvalidConfiguration(): void
    {
        ...
        $this->expectExceptionMessage('Failed to resolve configured directory "/non/existent/dir".');

        $this->fixer->configure(['dir' => '/non/existent/dir']);
    }
...
',
        ...
        yield StdinFileInfo::class.' are not supported' => [
            '<?php abstract class WrongName {}',
            null,
            [],
            new StdinFileInfo(),
