 ...
 */
#[CoversClass(NativeFunctionInvocationFixer::class)]
...
',
    ...
    public static function provideFix81Cases(): iterable
    {
        ...
        yield 'first-class callable with strict enabled' => [
            <<<'PHP'
                <?php
                namespace Foo;
                $a = \strlen(...);
    ...
    {
        yield 'first-class callable in pipe' => [
            <<<'PHP'
                <?php
                namespace Foo;
                $result = [] |> \array_unique(...) |> \array_values(...);
                PHP,
            <<<'PHP'
                <?php
                namespace Foo;
