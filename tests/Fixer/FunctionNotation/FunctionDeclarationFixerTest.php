...
final class FunctionDeclarationFixerTest extends AbstractFixerTestCase
{
     ...
     * @var _AutogeneratedInputConfiguration
     */
    private static array $configurationNamedSpacingOne = ['named_function_spacing' => FunctionDeclarationFixer::SPACING_ONE];
    ...
    public static function provideInvalidConfigurationCases(): iterable
    {
        ...
        yield [
            ['named_function_spacing' => 'neither'],
            '#^\[function_declaration\] Invalid configuration: The option "named_function_spacing" with value "neither" is invalid\. Accepted values are: "none", "one"\.$#',
        ];
    }
...
{#
        ...
        // named_function_spacing => one: add/collapse space between function name and (
        yield [
            '<?php function foo ($bar, $baz) {}',
            '<?php function foo($bar, $baz) {}',
            self::$configurationNamedSpacingOne,
        ];
