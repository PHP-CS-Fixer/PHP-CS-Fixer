...
',
    ...
    {
        yield 'asymmetric visibility - do not break nullable' => [
            <<<'PHP'
                <?php
                class Foo {
                    public function __construct (
        ...
        yield 'asymmetric visibility - do not remove nullable' => [
            <<<'PHP'
                <?php
                class Foo {
                    public function __construct (
                        protected(set) ?int $a = null,
                        protected(set) ?int $b = null,
                        private(set) ?int $c = null,
                    ) {}
                }
                PHP,
            null,
