...
final class RuleSetsTest extends TestCase
{
    ...
    public function testHasIntegrationTest(string $setDefinitionName): void
    {
        $setsWithoutTests = [
            ...
            '@PER-CS:risky',
            '@PHP5.6Migration',
            '@PHP5.6Migration:risky',
            '@PHP7.0Migration',
            '@PHP7.0Migration:risky',
            '@PHP7.1Migration',
            '@PHP7.1Migration:risky',
            '@PHP7.3Migration',
            '@PHP8.0Migration',
            '@PhpCsFixer',
            '@PhpCsFixer:risky',
            '@PHPUnit4.8Migration',
            '@PHPUnit5.5Migration:risky',
            '@PHPUnit7.5Migration:risky',
            '@PHPUnit8.4Migration:risky',
            '@PHPUnit9.1Migration:risky',
            '@PHPUnit10.0Migration:risky',
            '@PSR1',
        ];
