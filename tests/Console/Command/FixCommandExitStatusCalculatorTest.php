...
final class FixCommandExitStatusCalculatorTest extends TestCase
{
     ...
     * @param bool $isRawFormat
     *
     * @dataProvider provideCalculateCases
     */
    public function testCalculate($expected, $isDryRun, $hasChangedFiles, $hasInvalidErrors, $hasExceptionErrors, $hasLintErrorsAfterFixing, $isRawFormat)
    {
        $calculator = new FixCommandExitStatusCalculator();

        static::assertSame(
            $expected,
            $calculator->calculate($isDryRun, $hasChangedFiles, $hasInvalidErrors, $hasExceptionErrors, $hasLintErrorsAfterFixing, $isRawFormat)
        );
    }
    ...
    public function provideCalculateCases()
    {
        return [
            ...
            [76, true, true, true, true, false, false],
            [64, false, false, false, false, true, false],
            [64, false, false, false, true, false, false],
            [64, false, false, false, true, true, false],
            [8 | 64, true, true, false, true, true, false],
