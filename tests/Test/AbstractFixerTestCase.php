...
abstract class AbstractFixerTestCase extends TestCase
{
    ...
    final public function testProperMethodNaming(): void
    {
        ...
        $allowedExtraMethods = [
            ...
            PhpUnitTestCaseStaticMethodCallsFixerTest::class => ['testFixerContainsAllPhpunitStaticMethodsInItsList', 'testFixerContainsAllSymfonyStaticMethodsInItsList', 'testPHPUnit10', 'testPHPUnit11', 'testPHPUnit12', 'testPHPUnit13', 'testPHPUnit14'],
        ];
