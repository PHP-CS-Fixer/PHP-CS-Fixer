...
final class FixerFactoryTest extends TestCase
{
    ...
    public function provideFixersPriorityCases()
    {
        ...
        return [
            ...
            [$fixers['no_empty_statement'], $fixers['no_unneeded_nested_control_block']],
            ...
            [$fixers['no_unneeded_curly_braces'], $fixers['no_unneeded_nested_control_block']],
            ...
            [$fixers['no_unneeded_nested_control_block'], $fixers['no_extra_blank_lines']],
            [$fixers['no_unneeded_nested_control_block'], $fixers['no_superfluous_elseif']],
            [$fixers['no_unneeded_nested_control_block'], $fixers['no_useless_else']],
