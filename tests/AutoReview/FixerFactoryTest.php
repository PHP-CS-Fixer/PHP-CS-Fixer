...
final class FixerFactoryTest extends TestCase
{
    ...
    public function provideFixersPriorityCases()
    {
        ...
        return [
            ...
            [$fixers['no_useless_class_comment'], $fixers['no_empty_comment']],
            [$fixers['no_useless_class_comment'], $fixers['no_empty_phpdoc']],
            [$fixers['no_useless_class_comment'], $fixers['phpdoc_trim']],
            [$fixers['no_useless_class_comment'], $fixers['phpdoc_trim_consecutive_blank_line_separation']],
