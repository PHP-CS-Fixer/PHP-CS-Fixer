...
use PhpCsFixer\Fixer\Internal\PhpUnitRequiresWithCaretFixer;
...
return (new Config())
    ...
    ->registerCustomFixers([
        ...
        new PhpUnitRequiresWithCaretFixer(),
    ])
    ->setRules([
        '@PHP74Migration' => true,
        ...
        'PhpCsFixerInternal/php_unit_requires_with_caret' => true, // internal rules, shall not be used outside of main repo
