...
class Tokens extends \SplFixedArray
{
    ...
    /**
     * Check if token is one of type casting tokens.
     *
     * @param  string|array $token token element generated by token_get_all
     * @return bool
     */
    public static function isCasting($token)
    {
        ...
        return is_array($token) && in_array($token[0], $castingTokens);
    }
     ...
     *      @type string $whitespaces string determining whitespaces chars, default is " \t"
     * }
     * @return bool
     */
