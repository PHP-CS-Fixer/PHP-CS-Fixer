...
use Symfony\CS\Fixer\PSR2\ClassDefinitionFixer;
...
final class ClassDefinitionFixerTest extends AbstractFixerTestBase
{
    ...
    {
        ClassDefinitionFixer::configure(self::$defaultTestConfig);
    }

    public function testConfigureDefaultToNull()
    {
        ClassDefinitionFixer::configure(self::$defaultTestConfig);
        ClassDefinitionFixer::configure(null);
        ...
        $configProperty = new \ReflectionProperty('Symfony\CS\Fixer\PSR2\ClassDefinitionFixer', 'config');
        $configProperty->setAccessible(true);

        $this->assertSame($defaultConfigProperty->getValue(), $configProperty->getValue());
    }
    ...
    {
        ClassDefinitionFixer::configure($config);
        $this->makeTest($expected, $input);
    }
    ...
    {
        ClassDefinitionFixer::configure(array('a' => false));
    }
    ...
    {
        ClassDefinitionFixer::configure(array('singleLine' => 'z'));
    }
