...
Default value: ``['deprecated', 'internal', 'final', 'readonly', 'immutable', 'import-type', 'type', 'template', 'template-covariant', 'template-extends', 'extends', 'implements', 'property', 'method', 'param', 'throws', 'return', 'var', 'assert', 'assert-if-false', 'assert-if-true', 'requires', 'dataProvider', 'covers', 'author', 'see']``
...
With configuration: ``['order' => ['deprecated', 'internal', 'final', 'readonly', 'immutable', 'import-type', 'type', 'template', 'template-covariant', 'template-extends', 'extends', 'implements', 'property', 'method', 'param', 'throws', 'return', 'var', 'assert', 'assert-if-false', 'assert-if-true', 'requires', 'dataProvider', 'covers', 'author', 'see']]``.
