 ...
 *  omit_public_visibility_set_visibility_present?: bool,
 * }
    ...
    public function createConfigurationDefinition(): FixerConfigurationResolverInterface
    {
        ...
        return new FixerConfigurationResolver([
            ...
            (new FixerOptionBuilder(
                ...
                'Whether the general public visibility modifier should be omitted, if a set-visibility is specified.'
            ))
    ...
    protected function applyFix(\SplFileInfo $file, Tokens $tokens): void
    {
        ...
        foreach (array_reverse($tokensAnalyzer->getClassyElements(), true) as $index => $element) {
            ...
            if (null === $visibilityIndex) {
                if (false === $this->configuration['omit_public_visibility_set_visibility_present']) {
                ...
                if (
                    true === $this->configuration['omit_public_visibility_set_visibility_present']
                    && null !== $visibilitySetIndex
                    && $tokens[$visibilityIndex]->isGivenKind([\T_PUBLIC, CT::T_CONSTRUCTOR_PROPERTY_PROMOTION_PUBLIC])
                ) {
