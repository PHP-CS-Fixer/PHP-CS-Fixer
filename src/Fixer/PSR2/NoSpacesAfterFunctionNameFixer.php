...
final class NoSpacesAfterFunctionNameFixer extends AbstractFixer
{
    ...
    {
        return 'When making a method or function call, there MUST NOT be a space between the method or function name and the opening no_spaces_inside_parenthesis.';
    }
