...
final class NoSpacesInsideParenthesisFixer extends AbstractFixer
{
    ...
    public function fix(\SplFileInfo $file, Tokens $tokens)
    {
        foreach ($tokens as $index => $token) {
            ...
            // ignore no_spaces_inside_parenthesis for T_ARRAY
    ...
    {
        return 'There MUST NOT be a space after the opening no_spaces_inside_parenthesis. There MUST NOT be a space before the closing no_spaces_inside_parenthesis.';
    }
