...
',
    ...
    protected function applyFix(\SplFileInfo $file, Tokens $tokens): void
    {
        ...
        for ($index = 1; $index < $tokenCount; ++$index) {
            ...
            if (
                ...
                || $this->isMultilineConstructor($tokens, $index)
            ) {
    ...
    protected function createConfigurationDefinition(): FixerConfigurationResolverInterface
    {
        return new FixerConfigurationResolver([
            ...
            (new FixerOptionBuilder(
                ...
                ->getOption(),
            (new FixerOptionBuilder('multiline_constructor', 'Ensure constructor parameters are fully multiline.'))
                ->setAllowedTypes(['bool'])
                ->setDefault(false)
                ->getOption(),
        ]);
    ...
    private function isMultilineConstructor(Tokens $tokens, int $index): bool
    {
        $functionName = $tokens[$tokens->getPrevMeaningfulToken($index)];

        return $functionName->equals([T_STRING, '__construct'], false)
            && true === $this->configuration['multiline_constructor']
