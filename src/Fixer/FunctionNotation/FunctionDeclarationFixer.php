 ...
 *  named_function_spacing?: 'none'|'one',
...
final class FunctionDeclarationFixer extends AbstractFixer implements ConfigurableFixerInterface
{
            ...
            [
                ...
                new CodeSample(
                    <<<'PHP'
                        ...
                        PHP,
                    ['named_function_spacing' => self::SPACING_ONE],
                ),
            ],
        );
    }
    ...
    protected function applyFix(\SplFileInfo $file, Tokens $tokens): void
    {
        ...
        for ($index = $tokens->count() - 1; $index >= 0; --$index) {
            ...
            // fix whitespace before ( for named functions
            if (!$isLambda && !$tokens[$tokens->getPrevNonWhitespace($startParenthesisIndex - 1)]->isComment()) {
                if (self::SPACING_NONE === $this->configuration['named_function_spacing']) {
                    ...
                    // enforce single whitespace before (
                    // eg: `function foo() {}` => `function foo () {}`
                    $tokens->ensureWhitespaceAtIndex($startParenthesisIndex - 1, 1, ' ');
                }
            }
    ...
    protected function createConfigurationDefinition(): FixerConfigurationResolverInterface
    {
        return new FixerConfigurationResolver([
            ...
            (new FixerOptionBuilder('closure_fn_spacing', 'Spacing to use before open parenthesis for short arrow functions.'))
                ...
                ->setAllowedValues(self::SUPPORTED_SPACINGS)
                ->getOption(),
            (new FixerOptionBuilder('named_function_spacing', 'Spacing to use after function name in a function declaration (not a closure).'))
