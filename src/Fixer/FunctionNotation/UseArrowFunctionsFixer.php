 ...
 */
final class UseArrowFunctionsFixer extends AbstractFixer implements ConfigurableFixerInterface
{
    ...
    protected function createConfigurationDefinition(): FixerConfigurationResolverInterface
    {
        return new FixerConfigurationResolver([
            (new FixerOptionBuilder('one_liners_only', 'Whether fix only one-liner function or all.'))
                ->setAllowedTypes(['bool'])
                ->setDefault(true) // @TODO change to `false` as default on 4.0
                ->getOption(),
        ]);
    }
    ...
    protected function applyFix(\SplFileInfo $file, Tokens $tokens): void
    {
        ...
        for ($index = $tokens->count() - 1; $index > 0; --$index) {
            ...
            if (true === $this->configuration['one_liners_only'] && $this->isMultilined($tokens, $parametersStart, $parametersEnd)) {
                continue;
            }
            ...
            if (true === $this->configuration['one_liners_only'] && $this->isMultilined($tokens, $return, $semicolon)) {
                continue;
            }
