 ...
 * @author SpacePossum
 */
final class AlignOperatorSpacesFixer extends AbstractFixer implements ConfigurableFixerInterface
{
    /**
    ...
    public function fix(\SplFileInfo $file, Tokens $tokens)
    {
        ...
        for ($index = $tokens->count() - 2; $index >= 0; --$index) {
            ...
            if (false !== $isDeclare) {
                ...
                $this->alignWhiteSpaceAroundOperator($tokens, $index);
            }
...
',
     ...
     * @param int    $index
     */
    private function alignWhiteSpaceAroundOperator(Tokens $tokens, $index)
    {
