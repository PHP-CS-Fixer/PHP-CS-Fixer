...
',
    ...
    protected function configurePostNormalisation(): void
    {
        ...
        if (\defined('T_PRIVATE_SET')) { // @TODO: drop condition when PHP 8.4+ is required
            self::$tokenMapFollowedByASingleSpace['private_set'] = T_PRIVATE_SET;
            self::$tokenMapFollowedByASingleSpace['protected_set'] = T_PROTECTED_SET;
            self::$tokenMapFollowedByASingleSpace['public_set'] = T_PUBLIC_SET;
        }
