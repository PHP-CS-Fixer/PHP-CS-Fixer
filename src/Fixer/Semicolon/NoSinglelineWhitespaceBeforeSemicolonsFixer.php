...
final class NoSinglelineWhitespaceBeforeSemicolonsFixer extends AbstractFixer
{
     ...
     * {@inheritdoc}
     *
     * Must run after CombineConsecutiveIssetsFixer, FunctionToConstantFixer, LongToShorthandOperatorFixer, LongToShorthandOperatorForComplexTargetsFixer, NoEmptyStatementFixer, NoUnneededImportAliasFixer, SimplifiedIfReturnFixer, SingleImportPerStatementFixer.
     */
