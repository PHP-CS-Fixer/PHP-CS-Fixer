 ...
 *  property_hook_accessors_opening_brace?: 'next_line_unless_newline_at_signature_end'|'same_line',
 *  property_hooks_opening_brace?: 'next_line_unless_newline_at_signature_end'|'same_line',
 * }
        ...
        return new FixerDefinition(
            ...
            [
                ...
                new VersionSpecificCodeSample(
                    ...
                    [
                        'property_hooks_opening_brace' => self::NEXT_LINE_UNLESS_NEWLINE_AT_SIGNATURE_END,
                        'property_hook_accessors_opening_brace' => self::NEXT_LINE_UNLESS_NEWLINE_AT_SIGNATURE_END,
                    ],
                ),
            ],
        );
    ...
    public function createConfigurationDefinition(): FixerConfigurationResolverInterface
    {
        return new FixerConfigurationResolver([
            ...
            (new FixerOptionBuilder('anonymous_classes_opening_brace', 'The position of the opening brace of anonymous classes‘ body.'))
                ...
                ->setDefault(self::SAME_LINE)
                ->getOption(),
            (new FixerOptionBuilder('property_hooks_opening_brace', 'The position of the opening brace of property hooks‘ body.'))
                ->setAllowedValues([self::NEXT_LINE_UNLESS_NEWLINE_AT_SIGNATURE_END, self::SAME_LINE])
                ->setDefault(self::SAME_LINE)
                ->getOption(),
            (new FixerOptionBuilder('property_hook_accessors_opening_brace', 'The position of the opening brace of property hook accessors‘ (get/set) body.'))
                ->setAllowedValues([self::NEXT_LINE_UNLESS_NEWLINE_AT_SIGNATURE_END, self::SAME_LINE])
                ->setDefault(self::SAME_LINE)
                ->getOption(),
    ...
    protected function applyFix(\SplFileInfo $file, Tokens $tokens): void
    {
        ...
        foreach ($tokens as $index => $token) {
            ...
            if ($token->isGivenKind($classyTokens)) {
                ...
                $positionOption = 'property_hooks_opening_brace';
