 ...
 *  property_hook_body_opening_brace?: 'next_line_unless_newline_at_signature_end'|'same_line',
 *  property_hook_list_opening_brace?: 'next_line_unless_newline_at_signature_end'|'same_line',
 * }
        ...
        return new FixerDefinition(
            ...
            [
                ...
                new VersionSpecificCodeSample(
                    ...
                    [
                        'property_hook_list_opening_brace' => self::NEXT_LINE_UNLESS_NEWLINE_AT_SIGNATURE_END,
                        'property_hook_body_opening_brace' => self::NEXT_LINE_UNLESS_NEWLINE_AT_SIGNATURE_END,
                    ],
                ),
            ],
        );
    ...
    public function createConfigurationDefinition(): FixerConfigurationResolverInterface
    {
        return new FixerConfigurationResolver([
            ...
            (new FixerOptionBuilder('anonymous_classes_opening_brace', 'The position of the opening brace of anonymous classes‘ body.'))
                ...
                ->setDefault(self::SAME_LINE)
                ->getOption(),
            (new FixerOptionBuilder('property_hook_list_opening_brace', 'The position of the opening brace of property hooks‘ accessor list.'))
                ->setAllowedValues([self::NEXT_LINE_UNLESS_NEWLINE_AT_SIGNATURE_END, self::SAME_LINE])
                ->setDefault(self::SAME_LINE)
                ->getOption(),
            (new FixerOptionBuilder('property_hook_body_opening_brace', 'The position of the opening brace of property hook accessor (get/set) bodies.'))
                ->setAllowedValues([self::NEXT_LINE_UNLESS_NEWLINE_AT_SIGNATURE_END, self::SAME_LINE])
                ->setDefault(self::SAME_LINE)
                ->getOption(),
    ...
    protected function applyFix(\SplFileInfo $file, Tokens $tokens): void
    {
        ...
        foreach ($tokens as $index => $token) {
            ...
            if ($token->isGivenKind($classyTokens)) {
                ...
                $positionOption = 'property_hook_list_opening_brace';
                ...
                $positionOption = 'property_hook_body_opening_brace';
            } else {
                continue;
            }
            ...
            if (self::NEXT_LINE_UNLESS_NEWLINE_AT_SIGNATURE_END === $this->configuration[$positionOption]) {
                ...
                if ('property_hook_list_opening_brace' !== $positionOption) {
