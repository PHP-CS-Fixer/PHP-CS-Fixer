 ...
 */
final class PhpdocOrderFixer extends AbstractFixer implements ConfigurableFixerInterface, WhitespacesAwareFixerInterface
{
    ...
    public function getDefinition(): FixerDefinitionInterface
    {
        ...
        return new FixerDefinition(
            ...
            [
                ...
                new CodeSample($code, ['order' => ['param', 'throws', 'return']]),
    ...
    protected function createConfigurationDefinition(): FixerConfigurationResolverInterface
    {
        return new FixerConfigurationResolver([
            (new FixerOptionBuilder('order', 'Sequence in which annotations in PHPDoc should be ordered.'))
                ...
                ->setDefault(Future::getV4OrV3(['param', 'return', 'throws'], ['param', 'throws', 'return']))
                ->getOption(),
        ]);
    }
