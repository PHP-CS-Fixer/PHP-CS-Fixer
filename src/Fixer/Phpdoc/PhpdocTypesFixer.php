 ...
 *  groups?: list<'alias'|'meta'|'simple'|'soft_reserved'>,
 * }
...
final class PhpdocTypesFixer extends AbstractPhpdocTypesFixer implements ConfigurableFixerInterface
{
    ...
    private const POSSIBLE_TYPES = [
        ...
        // See https://www.php.net/manual/en/reserved.other-reserved-words.php for the list of soft reserved words.
        // Keywords other than "resource" are omitted for now, as they are not commonly used in PHPDoc.
        'soft_reserved' => [
            // 'enum',
            'resource',
            // 'numeric',
