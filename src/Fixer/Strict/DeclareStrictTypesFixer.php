 ...
 *  remove_existing_declaration?: bool,
 * }
...
final class DeclareStrictTypesFixer extends AbstractFixer implements ConfigurableFixerInterface, WhitespacesAwareFixerInterface
{
    ...
    protected function createConfigurationDefinition(): FixerConfigurationResolverInterface
    {
        return new FixerConfigurationResolver([
            (new FixerOptionBuilder('preserve_existing_declaration', 'Whether existing strict_types=? should be preserved and not overridden.'))
                ...
                ->setDefault(false)
                ->getOption(),
            (new FixerOptionBuilder('remove_existing_declaration', 'Whether existing strict_types=? should be removed, effectively turning strict mode off and using the engine into default type coercion mode. `preserve_existing_declaration` is ignored if this is set to `true`.'))
                ->setAllowedTypes(['bool'])
                ->setDefault(false)
                ->getOption(),
        ]);
    ...
    protected function applyFix(\SplFileInfo $file, Tokens $tokens): void
    {
        ...
        if ($this->configuration['remove_existing_declaration']) {
            if (null !== $declaration) {
