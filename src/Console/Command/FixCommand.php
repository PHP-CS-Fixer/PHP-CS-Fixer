...
apply (the fixer names must be separated by a comma):
    ...
    <info>php %command.full_name% /path/to/dir --rules=unix_line_endings,full_opening_tag,no_tabs</info>
...
using <comment>-name_of_fixer</comment>:
    ...
    <info>php %command.full_name% /path/to/dir --rules=-full_opening_tag,-no_tabs</info>
