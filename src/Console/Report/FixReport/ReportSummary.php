...
{
    /**
     * @var array<string, array{appliedFixers: list<string>, diff: string, newContent?: string}>
     */
    ...
    /**
     * @return array<string, array{appliedFixers: list<string>, diff: string, newContent?: string}>
     */
