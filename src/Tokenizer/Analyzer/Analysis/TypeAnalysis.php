...
final class TypeAnalysis implements StartEndTokenAwareAnalysis
{
     ...
     * More info:
     *
     * @see https://secure.php.net/manual/en/functions.arguments.php#functions.arguments.type-declaration.types
     * @see https://secure.php.net/manual/en/reserved.other-reserved-words.php
     * @see https://secure.php.net/manual/en/language.pseudo-types.php
     *
     * @var array
     */
