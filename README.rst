...
.. code-block:: bash
    ...
    php php-cs-fixer.phar fix /path/to/dir --rules=unix_line_endings,full_opening_tag,no_tabs
...
.. code-block:: bash
    ...
    php php-cs-fixer.phar fix /path/to/dir --rules=-full_opening_tag,-no_tabs
