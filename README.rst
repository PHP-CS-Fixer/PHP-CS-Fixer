...
.. code-block:: bash
    ...
    $ wget https://github.com/FriendsOfPHP/PHP-CS-Fixer/releases/download/v2.2.11/php-cs-fixer.phar -O php-cs-fixer
...
The file must return an instance of `PhpCsFixer\\ConfigInterface <https://github.com/FriendsOfPHP/PHP-CS-Fixer/blob/v2.2.11/src/ConfigInterface.php>`_
