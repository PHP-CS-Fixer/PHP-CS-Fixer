...
.. code-block:: bash
    ...
    $ wget https://github.com/FriendsOfPHP/PHP-CS-Fixer/releases/download/v2.11.2/php-cs-fixer.phar -O php-cs-fixer
...
* **blank_line_before_statement** [@Symfony]
  ...
  - ``statements`` (a subset of ``['break', 'continue', 'declare', 'die', 'do',
    'exit', 'for', 'foreach', 'goto', 'if', 'include', 'include_once',
    'require', 'require_once', 'return', 'switch', 'throw', 'try', 'while',
    'yield']``): list of statements which must be preceded by an empty line;
    defaults to ``['break', 'continue', 'declare', 'return', 'throw', 'try']``
...
The file must return an instance of `PhpCsFixer\\ConfigInterface <https://github.com/FriendsOfPHP/PHP-CS-Fixer/blob/v2.11.2/src/ConfigInterface.php>`_
